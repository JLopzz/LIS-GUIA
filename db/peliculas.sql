...
INSERT INTO pelicula (idpelicula, titulopelicula, descripcion, imgpelicula, titulooriginal, duracion, idgenero, iddirector) VALUES 
  ...
  (4, 'PD. Te Amo', 'La vida de Holly (Hilary Swank) se ve truncada cuando su marido, Gerry (Gerard Butler),muere. Incapaz de salir adelante por simisma, su madre y sus amigos intentan animarla. Un dia, despues de su 30 cumplea&ntilde;os, Holly recibe una carta de Gerry animandola a salir, a divertirse, a seguir adelante. Cada mes recibirauna carta firmada con un "Posdata: Te amo", que le devolveran las ganas de vivir.', 'img/ps.jpg', 'P.S. I love you', '115 min', 4,4),
  ...
  (6, 'Vacaciones en familia', 'Un ejecutivo preocupado por no perderse unas vacaciones con su familia decide llevarlos a vacacionar al mismo lugar donde tendr&aacute; una importante reuni&oacute;n de trabajo, pero sin dec&iacute;rselos', 'img/vacacionesenfamilia.jpg', 'RV', '98 min', 7,6),
  (7, 'La propuesta', 'Una poderosa editora llamada Margaret (Sandra Bullock) al enfrentarse ante la posibilidad de ser deportada a su pa&iacute;s de origen, Canad&aacute;, decide comprometerse con su asistente Andrew (Ryan Reynolds) con el prop&oacute;sito de evitarlo', 'imgla-propuesta-poster.jpg', 'The proposal', '108 min', 4,7),
  (8, 'Milagros inesperados', 'La pel&iacute;cula narra la vida de Paul Edgecomb (Tom Hanks), quien siendo un anciano de 108 a&ntilde;os, cuenta su historia como oficial de la Milla Verde, una penitenciar&iacute;a del estado de Luisiana, durante la d&eacute;cada de 1930. Edgecomb cuenta que entre sus presos tuvo un personaje con poderes sobrenaturales, capaz de sanar a personas.', 'img\\greenmille.jpg', 'The Green Mile', '189 min', 2,8);
