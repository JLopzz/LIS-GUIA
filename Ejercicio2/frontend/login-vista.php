...
<head>
    <meta charset="UTF-8">
    <title>Login / Register (Ejericio 2)</title>
...
<div class="container-form">
        <div class="header">
            ...
            <div class="menu">
                <a href="login.php"><li class="module-login active">Logiarse</li></a>
                <a href="register.php"><li class="module-register">Registrarse</li></a>
            </div>
        </div>
        
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            <div class="welcome-form"><h1>Bienvenido</h1><h2>Zanders</h2></div>
